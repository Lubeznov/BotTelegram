...
def convert(message: telebot.types.Message):
    try:
        ...
        if len(values) != 3:
            raise ConvertionException('много букав или мало , алё, написано же \
Чтобы начать работу введите боту комманду в следующем формате :\n<имя валюты> \
< в какую валюту перевести> \
<колличество переводимой валюты>.')
        ...
        bot.reply_to(message, f'Не обрабатывается команда. \n{e}')
    else:
